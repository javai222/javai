...
// OOP: DTO pattern — Decouples API shape from JPA entity; validation lives on the boundary type.
// KISS — Declarative Jakarta Validation constraints instead of manual checks scattered in controllers.
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder

...
// SOLID: SRP — Only maps request DTO to Employee entity; no persistence or HTTP.
// OOP: Composition over inheritance — builds aggregates via Employee.builder() instead of subclassing Employee.

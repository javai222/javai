...
// SOLID: SRP — HTTP adapter only: maps requests/responses; business rules stay in EmployeeService.
// SOLID: DIP — Depends on EmployeeService abstraction injected by the framework.
